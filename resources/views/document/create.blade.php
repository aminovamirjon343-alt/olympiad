        ...
        document.addEventListener('DOMContentLoaded', function() {
            const translations = {
                en: {
                    ...
                    draft: "Draft",
                    active: "Active",
                    fileLabel: "File (PDF, DOCX, XLSX, RTF)",
                ...
                ru: {
                    ...
                    draft: "Черновик",
                    active: "Активен",
                    fileLabel: "Файл (PDF, DOCX, XLSX, RTF)",
            ...
            window.addEventListener('storage', function(e) {
                if (e.key === 'app-lang') applyTranslations();
            });
            ...
            document.getElementById('file').addEventListener('change', function() {
                if (this.files[0]) {
                    fileNameEl.textContent = this.files[0].name.toUpperCase();
                    fileNameEl.setAttribute('data-is-custom', 'true');
                } else {
                    fileNameEl.setAttribute('data-is-custom', 'false');
                    applyTranslations();
                }
            });
        });
