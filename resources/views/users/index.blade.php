...
.level-connector {
    ...
    height: 48px;
    margin: 0 auto 32px;
    /* Убрал цветной градиент, сделал белым */
...
.level-connector::before { top: -6px; }
.level-connector::after { bottom: -6px; }
...
.level-bar {
    ...
    text-transform: uppercase;
    letter-spacing: 1px;
    /* Устанавливаем черный фон и белый текст */
...
/* Принудительно делаем все уровни черными с белым текстом */
.lvl-1, .lvl-2, .lvl-3, .lvl-4, .lvl-5, .lvl-default {
    background: black !important;
    color: white !important;
    border: 1px solid #333; /* Можно добавить тонкую серую рамку, чтобы не сливалось */
}
    /* === USERS GRID === */
    .users-grid {
        display: flex;
    ...
    .user-card:hover {
        ...
        box-shadow: 0 20px 48px -16px rgba(var(--glow), 0.45), 0 0 0 1px rgba(var(--glow), 0.15);
    }
    ...
    .creator-box {
        ...
        border-radius: 9px;
        margin: 12px 0;
        border-left: 3px solid rgba(var(--glow), 0.7);
    }
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // ФИЛЬТРЫ (если есть)
        // ============================================================
        // Здесь можно добавить логику фильтров по уровням, статусам и т.д.
