    ...
    <div class="min-h-screen bg-[#0f172a] py-12 users-page transition-colors duration-500">
        <div class="container mx-auto px-4">
            <style>
                ...
                .avatar-sq {
                    /* Используем переменную --primary из твоей админки.
                       Если она не задана, сработает запасной цвет #f59e0b */
            ...
            <div class="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="profile-card p-8 text-center h-full flex flex-col justify-center">
                        ...
                        {{-- Здесь исправлено: Email теперь маленький и не ломает верстку --}}
                        <div class="px-2 mb-8">
                ...
                <div class="lg:col-span-2">
                    <div class="profile-card h-full flex flex-col">
                        <div class="px-8 py-5 border-b border-slate-50 bg-slate-50/50">
                            <h3 class="info-label !mb-0" style="color: #6366f1 !important;">Детальные данные</h3>
                        </div>
                        ...
                        <div class="p-10 flex-grow">
                            ...
                            <div class="mt-12 pt-8 border-t border-slate-100">
                                ...
                                <div class="flex items-center gap-3">
                                    ...
                                    <span class="text-[11px] font-black uppercase text-slate-700">Активный доступ</span>
                                </div>
                            </div>
                        </div>
                    </div>
