    ...
    <div class="container mx-auto px-4 py-6 min-h-screen">
        ...
        @php
            ...
            if ($filePath && Storage::disk('public')->exists($filePath)) {
                ...
                $fileSize = Storage::disk('public')->size($filePath); // Читаем реальный размер с диска
        ...
        <div class="view-sig-page">
            ...
            <span class="label-micro">
                ...
                <span data-i18n="previewLabel">Предпросмотр</span>
                            ...
                            @if($isWord)
                                <span class="text-[11px] bg-blue-100 text-blue-700 px-3 py-1 rounded-full font-bold uppercase">WORD</span>
                            @endif

                            @if($isPdf)
                                <span class="text-[11px] bg-red-100 text-red-700 px-3 py-1 rounded-full font-bold uppercase">PDF</span>
                            @endif

                            @if($isExcel)
                                <span class="text-[11px] bg-emerald-100 text-emerald-700 px-3 py-1 rounded-full font-bold uppercase">EXCEL</span>
                            @endif
                        ...
                        <div class="flex items-center gap-2">
                            @if($filePath)
                                <button id="fullScreenBtn" onclick="toggleFullScreen()" class="bg-indigo-600 text-white px-3 py-2 rounded-xl text-[11px] font-black uppercase tracking-widest hover:bg-indigo-700 transition-all flex items-center justify-center shadow-md shadow-indigo-500/20">
                    ...
                    <div id="previewBox" class="preview-container">
                        @if($filePath)
                            ...
                            @else
                                ...
                                @php
                                    // Добавлена логика для корректного формирования ссылки на просмотр
